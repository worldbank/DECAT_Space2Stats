...
class FieldSelector:
    ...
    Example:
        ...
        from space2stats_client.widgets import FieldSelector

        client = Space2StatsClient()
        selector = FieldSelector(client)
        selector.display()
    ...
    def _group_fields_by_stac_items(self):
        ...
        with self.output:
            try:
                # Access the catalog from the client
                ...
                collection_url = collection.self_href
                ...
                for item_link in items_links:
                    ...
                    try:
                        ...
                        group_name = item_link.get("title") or item_data.get(
                            "properties", {}
                            ...
                            for column in columns:
                                ...
                                if field_name and field_name.lower() in [
                                    ...
                                    if exact_field:
                                        ...
                                        self.field_descriptions[exact_field] = (
